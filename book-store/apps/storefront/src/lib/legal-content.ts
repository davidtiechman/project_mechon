...
export const legalPages: Record<string, ContentItem> = {
  terms: {
    ...
    content: `<h2>כללי</h2><p>[יש להוסיף את הנוסח המשפטי המאושר]</p><h2>ביצוע רכישה</h2><p>[יש להשלים תנאי הזמנה, תשלום ואספקה]</p><h2>פרטי הגוף המפעיל</h2><p>[שם משפטי] · [מספר תאגיד/עוסק] · [כתובת]</p>`,
  },
  privacy: {
    id: "fallback-privacy",
    slug: "privacy",
  ...
  contact: {
    ...
    content: `<h2>פרטי קשר</h2><p>[שם הגוף המפעיל] · [טלפון] · [אימייל] · [כתובת]</p>`,
  },
}
