      ...
      <div className="flex flex-col w-full">
        ...
        <div className="flex relative z-0 w-full txt-compact-medium">
          <input
            ...
            className={`pt-4 pb-1 block w-full h-11 px-4 ${type === "password" ? "pe-12" : ""} mt-0 bg-ui-bg-field border rounded-md appearance-none focus:outline-none focus:ring-0 focus:shadow-borders-interactive-with-active border-ui-border-base hover:bg-ui-bg-field-hover`}
            {...props}
            ref={inputRef}
          />
          <label
            ...
            className="flex items-center justify-center ms-3 px-1 transition-all absolute duration-300 top-3 start-0 -z-1 text-ui-fg-subtle"
          >
            {label}
