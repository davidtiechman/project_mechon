        ...
        <div className="grid gap-12 border-b border-white/15 pb-12 small:grid-cols-2 medium:grid-cols-3 large:grid-cols-[1.3fr_1fr_1fr_1fr_1fr]">
          <div className="max-w-md">
            ...
            <p className="mt-6 leading-7 text-[#d8d0c0]">
              מחקר, ההדרה והוצאה לאור של ספרי קודש במהדורות מדויקות ומאירות
              עיניים.
            </p>
          </div>
          <div>
            <h2 className="footer-heading">ניווט</h2>
            <ul className="footer-links">
              ...
              <li>
                <LocalizedClientLink href="/#new-books">
                  ספרים חדשים
                </LocalizedClientLink>
              </li>
              <li>
          ...
          <div>
            <h2 className="footer-heading">קטגוריות</h2>
            <ul className="footer-links">
