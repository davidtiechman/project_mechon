export const siteContentEn = {
  ...
  mediaHint: "Upload an image (JPG, PNG, WebP) or a PDF file.",
  mediaUrlPlaceholder: "The uploaded file URL will appear here",
  uploading: "Uploading… Do not save until the upload is complete.",
  uploadSuccess: "The file was uploaded successfully. Save the advertisement to apply it.",
  uploadError: "The file upload failed. Please try again.",
  uploadTypeError: "Only image or PDF files can be uploaded.",
...
export const siteContentHe = {
  ...
  mediaHint: "אפשר להעלות תמונה (JPG, PNG, WebP) או קובץ PDF.",
  mediaUrlPlaceholder: "כתובת הקובץ שהועלה תופיע כאן",
  uploading: "מעלה… אין לשמור עד לסיום ההעלאה.",
  uploadSuccess: "הקובץ הועלה בהצלחה. יש לשמור את המודעה כדי להחיל אותו.",
  uploadError: "העלאת הקובץ נכשלה. יש לנסות שוב.",
  uploadTypeError: "ניתן להעלות קובצי תמונה או PDF בלבד.",
