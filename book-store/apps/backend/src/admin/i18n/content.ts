export const siteContentEn = {
  ...
  fields: {
    ...
    value: "Value (JSON)", seo: "SEO (JSON)", products: "Products", short_description: "Short description", desktop_image: "Desktop image", group: "Group", type: "Section type", owner_id: "Owner ID",
  },
...
export const siteContentHe = {
  ...
  fields: {
    ...
    value: "ערך (JSON)", seo: "SEO (JSON)", products: "מוצרים", short_description: "תיאור קצר", desktop_image: "תמונה למחשב", group: "קבוצה", type: "סוג מקטע", owner_id: "מזהה בעלים",
  },
