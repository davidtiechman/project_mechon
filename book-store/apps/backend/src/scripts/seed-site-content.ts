...
const legalPages = [
  ...
  [
    "contact",
    "צור קשר",
    'מכון מעשה רוקח מופעל על ידי מעשה רוקח בע"מ · ח.פ. 514692946 · טלפון: <a href="tel:025386591">02-5386591</a> · פקס: 02-5386379 · דוא״ל: <a href="mailto:5386591@gmail.com">5386591@gmail.com</a> · דובר שלום 7 מיקוד: 9447607 ירושלים',
  ],
] as const;
